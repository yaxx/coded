    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu" id="myUL" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
...
<li class="nav-item  ">
        ...
        <ul class="sub-menu">
            <li class="nav-item  ">
                <a href="{{  url('vendor') }}" class="nav-link nav-toggle">
                <i class="icon-user-follow"></i>
                    <span class="title">Vendor</span>
                </a>
            </li>
            <li class="nav-item  ">
                <a href="{{url('procurement_items')}}" class="nav-link nav-toggle">
                <i class="icon-list"></i>
            ...
            <li class="nav-item  ">
                ...
                <i class="icon-user-follow"></i>
                    ...
                    <ul class="sub-menu">
                            <li class="nav-item  ">
                                    <a href="{{ url('purchase_order') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-cc-mastercard"></i>
                                        <span class="title">Local Purchase Oder</span>
                                     </a>
                                </li>
                                <li class="nav-item  ">
                                        <a href="{{url('approve_lpo_request') }}" class="nav-link nav-toggle">
                                        <i class="icon-user-following"></i>
                                            <span class="title">Approve LPO</span>
                                         </a>
                                    </li>
                                     <li class="nav-item  ">
                                    <a href="{{url('confirm_lpo_delivery') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-check-square-o"></i>
                                        <span class="title">Confirm LPO Supply</span>
                                     </a>
                                </li>
                                <li class="nav-item  ">
                                        <a href="{{ url('lpo_status_report') }}" class="nav-link nav-toggle">
                                        <i class="icon-bar-chart"></i>
            ...
            <li class="nav-item  ">
                    <a href="" class="nav-link nav-toggle">
                    <i class="icon-bar-chart"></i>
                        <span class="title">Analytical Report</span>
                        <span class="arrow"></span>
                        <ul class="sub-menu">
                                <li class="nav-item  ">
                                        <a href="{{  url('vendor_report') }}" class="nav-link nav-toggle">
                                        <i class="icon-bar-chart"></i>
                                            <span class="title">Vendor Report</span>
                                         </a>
                                    </li>
                                    <li class="nav-item  ">
                                            <a href="{{ url('lpo_performance_report') }}" class="nav-link nav-toggle">
                                            <i class="icon-bar-chart"></i>
                                        ...
                                        <li class="nav-item  ">
                                            ...
                                            <li class="nav-item  ">
                                                    <a href="{{ url('payment_outstanding_report') }}" class="nav-link nav-toggle">
                                                    <i class="icon-bar-chart"></i>
    ...
    <li class="nav-item  ">
            ...
            <ul class="sub-menu">
                <li class="nav-item  ">
                    <a href="{{ url('sales_items')}}" class="nav-link nav-toggle">
                    <i class="icon-wallet"></i>
                        <span class="title">Sales Item</span>
                    </a>
                </li>
                <li class="nav-item  ">
                    <a href="{{ url('sales_coupon')}}" class="nav-link nav-toggle">
                    <i class="fa fa-book"></i>
                        <span class="title">Discount Coupon</span>
                    </a>
                 </li>
                 <li class="nav-item  ">
                        <a href="{{ url('sales_products')}}" class="nav-link nav-toggle">
                        <i class="fa fa-cart-plus"></i>
                            <span class="title">Sales Product</span>
                        </a>
                    </li>
                <li class="nav-item  ">
    ...
    <li class="nav-item  ">
    <li class=""> <a href="{{ url('/accounts/settings') }}">
   ...
   @endif
    ...
    <li class="nav-item  ">
            <a href="javascript:;" class="nav-link nav-toggle">
            <i class=""></i>
            <span class="uppercase">HR Operations</span>
            <small ><span class="text-danger"> </span></small>
            <span class="arrow"></span>
            </a>
            <ul class="sub-menu">
      ...
      @if(Auth::user()->hasAnyRole(['PayRoll Officer', 'Accounts']))
        ...
        @else(client_type_id() == 2)
            ...
            <li class="nav-item  ">
                    <a href="javascript:;" class="nav-link nav-toggle">
                    <i class=""></i>
                    <span class="uppercase">Payroll Operations</span>
                    <small ><span class="text-danger"> </span></small>
                    <span class="arrow"></span>
                    </a>
                    <ul class="sub-menu">
                    ...
                    @endif
                        ...
                        <li class="nav-item  ">
                            <a href="{{ url('qualifications') }}" class="nav-link ">
                                <i class="icon-graduation icon"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="icon-screen-tablet icon"></i>
...
<!--Report-->
   ...
   <!-- Note: 1 - Private 2 - Government 3 - Pension -->
@elseif ( (groupid() == 111111 || groupid() == 222222) || (groupid() >= 3000 && groupid() <= 3999)  && client_type_id() == 3 )     
    <!--Pension-->
