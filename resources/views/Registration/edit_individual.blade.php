...
@section ('contents')
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Edit Individual</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject sbold uppercase font-blue" >Edit Individual</span>
                                    </div>
                                ...
                                <form method="post" role="form" id="addUser" name="addUser" action="{{ route('individual_registration.update', ['id'=>$id]) }}">
            ...
            <div class="form-group {{ $errors->has('revenue_payer_lname') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="revenue_payer_lname" name="revenue_payer_lname"  value="{{ Request::old('revenue_payer_lname') ?:$individual->revenue_payer_lname }}" placeholder="SurName" required>
              </div>
          ...
          <div class="col-md-6">
            <div class="form-group  {{ $errors->has('revenue_payer_fname') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <input type="text" class="form-control" id="revenue_payer_fname" name="revenue_payer_fname" value="{{ Request::old('revenue_payer_fname') ?:$individual->revenue_payer_fname }}" placeholder="First Name" required>
              </div>
            ...
            <div class="form-group {{ $errors->has('revenue_payer_mname') ? ' has-error' : '' }}">
              ...
              <div class="input-group">
                  <span class="input-group-addon"><i class="fa fa-user"></i></span>
                  <input type="text" class="form-control" id="revenue_payer_mname" name="revenue_payer_mname" value="{{ Request::old('revenue_payer_mname') ?:$individual->revenue_payer_mname }}" placeholder="Middle Name" >
              </div>
