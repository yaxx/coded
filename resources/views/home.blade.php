        ...
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-blue-sharp">
                    <small> Number of Users:</small>  <span data-counter="counterup" data-value="{{$userCount}}"></span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-red-haze">
                    <small>Budget Year:</small>  <span data-counter="counterup"  data-value="{{ old('budget_year')?:date('Y')}}">0</span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-green-sharp">
                    <small>{{ MINISTRY() }}:</small>  <span data-counter="counterup" data-value="0">0</span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-purple-soft">
                    <small>Departments:</small> <span data-counter="counterup" data-value="0">0</span>
                </h3>
            </div>
        </div>
    </div>
