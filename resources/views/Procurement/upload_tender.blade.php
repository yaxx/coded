...
@section ('contents')
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Upload SIB</span>
                        </li>
                    </ul>
                    <!-- END PAGE BREADCRUMB -->
                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject sbold uppercase font-blue" >Upload Tender</span>
                                    </div>
                                    ...
                                    <div class="form-body">
                                         <div class="row">
                                           <div class="col-md-6">
                                                ...
                                                placeholder= "Enter name of project/plan"
                                              		 required>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Upload Tender <span class="required">*</span></label>
                                            <div class="col-md-12">
