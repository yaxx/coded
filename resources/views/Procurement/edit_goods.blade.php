                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject sbold uppercase font-blue">Edit Procurement Plan </span>
                            </div>
                        </div>
                        ...
                        <div id="tabs">
                            ...
                            <form method="post" role="form" id="personal-form" name="procurement-plan"
                                action="{{ route('procurement.creategoods') }}" enctype="multipart/form-data">
                                @csrf
                                <!--Start Tab content -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div
                                                    ...
                                                    <label for="budget_plan_reference_no" class="control-label">Budget
                                                        year
                                                        <span class="required">*</span></label>
                                                    <select name="budget_plan_reference_no" id="budget_plan_reference_no"
                                                        class="form-control" required>
                                                        <option value="{{$goodsplan->budget_year}}">{{$goodsplan->budget_year}}</option>
                                                ...
                                                <div class=" requiredBlock form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control" id="budget_id" name="budget_id">
                                                            <option value="{{$goodsplan->project_title}}" disabled selected>{{$goodsplan->project_title}} </option>
                                                        </select>
                                            ...
                                            <div
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{$goodsplan->procurement_officer_number }}"
                                            ...
                                            <div class="form-group {{ $errors->has('project_cost') ? 'has-error' : '' }}">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input readonly type="text" class="form-control comma-format"
                                                        value="{{$goodsplan->project_cost}}" id="project_cost" name="project_cost"
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                                    <input type="text" class="form-control"
                                                        value="{{$goodsplan->project_location}}"
                                            ...
                                            <div
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" id="project_status"
                                                        ...
                                                        <option value="{{$goodsplan->project_status}}">{{$goodsplan->project_status}}</option>
                                                                        ...
                                                                        <div class=" requiredBlock form-group ">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="text" class="form-control "
                                                                                    ...
                                                                                    placeholder="Enter package number" value={{$goodsplan->package_number}}" required>
                                                                            </div>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="lot_number" name="lot_number"
                                        placeholder="Enter Lot Number" pattern="^[A-Za-z0-9.,_\- ]+$" value="{{$goodsplan->lot_number}}" required>
                                </div>
                                @if ($errors->has('lot_number'))
                                    <span class="help-block">{{ $errors->first('lot_number') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control comma-format" id="budget_available"
                                        name="budget_available" placeholder="Enter available threshold" value="{{$goodsplan->budget_available}}" required>

                                </div>
                                @if ($errors->has('available_threshold'))
                                    <span class="help-block">{{ $errors->first('available_threshold') }}</span>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="procurement_method"  name="procurement_method" 
                                        required>
                                        <option value="{{$goodsplan->procurement_method}}">{{$goodsplan->procurement_method}}</option>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="weeks" name="goods_arrival" required>
                                        <option value="{{$goodsplan->goods_arrival}}">{{$goodsplan->goods_arrival}}</option>
                                        @for ($i = 1; $i <= 30; $i++)
                    ...
                    <div class="row">
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="weeks" name="submission_of_evaluation_period"
                                        required>
                                        <option value="{{$goodsplan->submission_of_evaluation_period}}">{{$goodsplan->submission_of_evaluation_period}}</option>
                                        @for ($i = 1; $i <= 30; $i++)
                                            <option {{ old('weeks') == $i ? 'selected' : '' }}
                                                value="{{ $i }}">{{ $i }}
                                                week{{ $i > 1 ? 's' : '' }} </option>
                        ...
                        <div class="col-md-6">
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <input type="text" class="form-control comma-format" value="{{$goodsplan->mobilization}}"
                        ...
                        <div class="col-md-6">
                            <div
                                ...
                                <input name="bid_opening_date" id="bid_opening_date" type="date"
                                    ...
                                    value="{{$goodsplan->bid_opening_date }}"
                                    required>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control comma-format" id="certifiable_amount"
                                        name="certifiable_amount" placeholder="Enter Certifiable Amount" value="{{$goodsplan->certifiable_amount }}" required>
                                </div>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="contract_signature" name="contract_signature"
                                        required>
                                        <option value="{{$goodsplan->contract_signature }}">{{$goodsplan->contract_signature }}</option>
                                        @for ($i = 1; $i <= 30; $i++)
                                            <option {{ old('weeks') == $i ? 'selected' : '' }}
                                                value="{{ $i }}">
                                                {{ $i }}
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="final_acceptance" name="final_acceptance" required>
                                        <option value="{{$goodsplan->final_acceptance }}">{{$goodsplan->final_acceptance }}</option>
                                        @for ($i = 1; $i <= 30; $i++)
                                            <option {{ old('weeks') == $i ? 'selected' : '' }}
                                                value="{{ $i }}">
                                                {{ $i }}
                        ...
                        <div class="col-md-6">
                            <div class="requiredBlock form-group ">
                                <label>Bill of quantity <span id="bill_of_quantity" class="required">*</span><a
                                        href="#" data-toggle="tooltip"
                                        title=" Please submit the bill of quantity  ">(i)</a></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-file"></i></span>
                                    <input type="file" class="form-control" id="bill_of_quantity"
                                        name="bill_of_quantity" value="{{$goodsplan->bill_of_quantity }}" required>
                                </div>
                            ...
                            <div class=" requiredBlock form-group ">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="contract_offer" name="contract_offer" required>
                                        <option value="{{$goodsplan->contract_offer }}">{{$goodsplan->contract_offer }}</option>
                                        @for ($i = 1; $i <= 30; $i++)
                                            <option {{ old('weeks') == $i ? 'selected' : '' }}
                                                value="{{ $i }}">
                                                {{ $i }}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12 text-right">
                                <a href="" class="btn default"><i class="fa fa-close"></i>
                                    Cancel</a>
                                <button class="btn green" name="submit" value="1">Update
                                    Plan </button>
                            </div>
                        </div>
                    </div>
