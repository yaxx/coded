        ...
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-blue-sharp">
                    <small>Registered Contractors:</small>  <span data-counter="counterup" data-value="0">0</span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-red-haze">
                    <small>Accepted Plans:</small>  <span data-counter="counterup"  data-value="0">0</span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="number">
                <h3 class="font-green-sharp">
                    <small>Rejected Plans:</small>  <span data-counter="counterup" data-value="0">0</span>
                </h3>
            </div>
        </div>
        <div class="col-md-3">
