...
@section ('contents')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Approve Budgets</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject sbold uppercase font-blue">Approve Budgets </span>
                    </div>
                </div>
                ...
                <form method="post" role="form" id="approveBudget" name="approveBudget" action="{{ route('approve_budgets.store') }}">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                            ...
                            <tr>
                                ...
                                <th>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                            <input type="checkbox" class="checkboxes" name="checkAll" id="checkAll" /> 
                                            <span></span>
                                    </label>
                                </th>
                            </tr>
                       ...
                       @foreach($budget_approvals as $budget)
                            <tr>
                                ...
                                <td>{{ $budget->approval_level ? $budget->approval_level->approval_level : '0' }} out of {{ $countLevels }}</td>
                                ...
                                <td>
                                    <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                        <input type="checkbox" class="checkboxes" name="approved[]" value="{{ $budget->approval_request_id }}" />
                                        <span></span>
                                    </label>
                                </td>
                            </tr>
                     @endforeach 
                        ...
                        <div class="form-actions" align="right">
                            ...
                            <input type="hidden" id="countLevels" name="countLevels" value="{{ $countLevels }}">  

                            <button type="submit" class="btn blue" onclick="return confirm('Are you sure?');" >Approve</button>
                            <a class="btn red btn-outline" href="{{ route('approve_budgets.index') }}">Cancel</a>
