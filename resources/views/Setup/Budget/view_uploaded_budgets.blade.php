...
@section ('contents')
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Uploaded Budgets</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject sbold uppercase font-blue">Uploaded Budgets </span>
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                        ...
                        <tbody>
                       @foreach($uploaded_budgets as $budget)
                              <tr>
                                ...
                                <td>
                                     <span class="badge badge-{{ $budget->enabled == 1 ? 'success' : 'danger' }}">
                                        {{ $budget->enabled == 1 ? 'Active' : 'Inactive' }} </span>
                                </td>
                                <td>
