            ...
            <div class="portlet light bordered">
                ...
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <a class="btn green" href="{{route('agencies.create')}}">Add New <i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="tools"></div>
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                       ...
                       @foreach($agencies as $agency)
                              <tr>
                                <td>
                                    <input type="checkbox" name="selected_agencies[]" value="{{ $agency->id }}">
                                </td>
                                <td>{{ $agency->agency_name }}</td>
                                <td>{{ $agency->account_name }}</td>
                                <td>{{ $agency->account_no }}</td>
                                ...
                                <td>
                                     <a href="{{ route( 'agencies.edit',['id'=>$agency->uuid] ) }}" ><i class="fa fa-pencil"></i> Edit </a>
                                </td>
                            </tr>
                     @endforeach 
                        </tbody>
